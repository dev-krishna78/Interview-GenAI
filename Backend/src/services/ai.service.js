  ...
  technicalQuestions: z
    .array(
      z.object({
        ...
        answer: z.string().describe("How to answer this technical question, what points to cover, what approach to take etc."),
      })
    )
  ...
  behavioralQuestions: z
    .array(
      z.object({
        ...
        answer: z.string().describe("How to answer this behavioral question, what points to cover, what approach to take etc."),
      })
    ...
    .array(
      z.object({
        ...
        severity: z
          ...
          .describe("The severity of this skill gap, i.e. how important this skill is for the job and how much it can impact the candidate's chances"),
      })
    )
...
Rules:
- technicalQuestions must contain at least 5 objects
- behavioralQuestions must contain at least 5 objects
